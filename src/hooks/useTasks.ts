  ...
  const buildQuery = () => {
    ...
    switch (kind) {
      case 'my':
        ...
        // Individual tasks: assigned to user AND no team_id (to exclude team tasks)
      ...
      case 'team':
        if (params.teamId) {
          // Team tasks: must have team_id
          query = query.eq('team_id', params.teamId);
        } else {
          // If no specific team, show tasks with any team_id (not null)
